...
},{"../models/message":6}],2:[function(require,module,exports){
...
},{"./../../../bower_components/backbone/backbone.js":29,"./../../../bower_components/bootstrap/dist/js/bootstrap.js":30,"./../../../bower_components/jquery-snowfall/dist/snowfall.jquery.min.js":31,"./../../../bower_components/jquery/dist/jquery.js":32,"./../../../bower_components/underscore/underscore.js":33,"./lib/jquery.serializeObject":5,"./router":7,"./views/includes/background":8}],3:[function(require,module,exports){
...
},{"./../../../../bower_components/jquery/dist/jquery.js":32}],6:[function(require,module,exports){
...
Router.on('route:message', function() {
  var Message;
  return Message = require('./views/message');
});
...
Router.on('route:thank', function() {
  var Thank;
  return Thank = require('./views/thank');
});
...
},{"./views/index":13,"./views/message":14,"./views/present":15,"./views/thank":16}],8:[function(require,module,exports){
...
},{"../../../tmpl/background.hbs":17,"hbsfy/runtime":53}],9:[function(require,module,exports){
...
},{"../../../tmpl/components/footer.hbs":18,"./share-modal":11,"./terms-modal":12,"hbsfy/runtime":53}],10:[function(require,module,exports){
...
},{"../../../tmpl/components/header.hbs":19,"../../../tmpl/components/share-modal.hbs":21,"hbsfy/runtime":53}],11:[function(require,module,exports){
var Handlebars;
...
},{"../../../tmpl/components/share-modal.hbs":21,"hbsfy/runtime":53}],12:[function(require,module,exports){
var Handlebars;
...
},{"../../../tmpl/components/terms-modal.hbs":22,"hbsfy/runtime":53}],13:[function(require,module,exports){
var Handlebars, Index;
...
},{"../../tmpl/index.hbs":24,"./includes/footer":9,"./includes/header":10,"hbsfy/runtime":53}],14:[function(require,module,exports){
var Handlebars, Message;
...
Message = Backbone.View.extend({
  ...
  submit: function(event) {
     ...
     */
    return this.$el.find('.message-content').replaceWith(this.successTmpl(data));
  },
  termsModal: function(event) {
    event.preventDefault();
    new this.termsModalView();
...
},{"../../tmpl/components/message-success.hbs":20,"../../tmpl/message.hbs":25,"../lib/backbone.validation.callbacks.bootstrap":3,"../models/message":6,"./../../../../bower_components/backbone.validation/dist/backbone-validation.js":28,"./includes/footer":9,"./includes/header":10,"./includes/terms-modal":12,"hbsfy/runtime":53}],15:[function(require,module,exports){
...
},{"../../tmpl/present.hbs":26,"../collections/present":1,"../lib/getUrlVars":4,"./includes/footer":9,"./includes/header":10,"hbsfy/runtime":53}],16:[function(require,module,exports){
var Handlebars, Thank, getUrlVars;
...
Thank = Backbone.View.extend({
  ...
  submit: function(event) {
    ...
    event.preventDefault();
    data = $(event.currentTarget).serializeObject();
    return this.$el.find('.message-content').replaceWith(this.successTmpl(this.modal));
  },
  render: function(res) {
    var Footer, Header;
    if (!res.models.length) {
...
},{"../../tmpl/components/thank-success.hbs":23,"../../tmpl/thank.hbs":27,"../collections/present":1,"../lib/getUrlVars":4,"./includes/footer":9,"./includes/header":10,"hbsfy/runtime":53}],17:[function(require,module,exports){
...
},{"hbsfy/runtime":53}],18:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
...
},{"hbsfy/runtime":53}],19:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
...
},{"hbsfy/runtime":53}],20:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    var helper;
...
},{"hbsfy/runtime":53}],21:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    return "<div id='share-modal' class=\"modal fade\">\n  <div class=\"modal-dialog\">\n    <div class=\"modal-content\">\n      <div class=\"modal-header\">\n        <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-label=\"Close\"><span aria-hidden=\"true\">&times;</span></button>\n      </div>\n      <div class=\"modal-body\">\n        <div class='row'>\n          <div class='col-xs-6'>\n            <button type='button' class='btn btn-facebook btn-block' data-url='https://www.facebook.com/sharer/sharer.php?u=example.com'>\n              <i class='fa fa-facebook'></i>\n              Facebook\n            </button>\n          </div>\n          <div class='col-xs-6'>\n            <button type='button' class='btn btn-twitter btn-block' data-url='https://twitter.com/intent/tweet?text=Something'>\n              <i class='fa fa-twitter'></i>\n              Twitter\n            </button>\n          </div>\n        </div>\n      </div>\n      <div class=\"modal-footer\">\n        <button type=\"button\" class=\"btn btn-default\" data-dismiss=\"modal\">Close</button>\n      </div>\n    </div><!-- /.modal-content -->\n  </div><!-- /.modal-dialog -->\n</div><!-- /.modal -->\n";
},"useData":true});

},{"hbsfy/runtime":53}],22:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
...
},{"hbsfy/runtime":53}],23:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    var helper;
...
},{"hbsfy/runtime":53}],24:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    return "<div id='homepage'>\n  <div class='container'>\n    <div id='header'></div>\n\n    <h1 class='page-title'>Christmas Dumberland</h1>\n    <p class='intro-text'>Send a Dumb Christmas surprise.<br>Select a present to start.</p>\n\n    <div class='presents-container'>\n      <div class='present'><img src='/assets/img/present.png' alt='Christmas present'></div>\n      <div class='present'><img src='/assets/img/present.png' alt='Christmas present'></div>\n      <div class='present'><img src='/assets/img/present.png' alt='Christmas present'></div>\n      <div class='present'><img src='/assets/img/present.png' alt='Christmas present'></div>\n      <div class='present'><img src='/assets/img/present.png' alt='Christmas present'></div>\n      <div class='present'><img src='/assets/img/present.png' alt='Christmas present'></div>\n    </div>\n </div>\n\n  <div id='footer'></div>\n</div>\n\n";
},"useData":true});

},{"hbsfy/runtime":53}],25:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
...
},{"hbsfy/runtime":53}],26:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
...
},{"hbsfy/runtime":53}],27:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    var helper, alias1=depth0 != null ? depth0 : {}, alias2=helpers.helperMissing, alias3="function", alias4=container.escapeExpression;
...
},{"hbsfy/runtime":53}],28:[function(require,module,exports){
...
},{"./../jquery/dist/jquery.js":32,"./../underscore/underscore.js":33}],30:[function(require,module,exports){
/*!
